// JavaScript Document
	...
	*/
	...
	//YouTube
	function posarDescripcioYouTube(text){  
		document.getElementById("descripcioYoutube").innerHTML = text;
	}
	function borrarDescripcioYouTube(){  
	    document.getElementById("descripcioYoutube").innerHTML = "";  
	}
	//Edad
	function posarDescripcioEdat(text){  
		document.getElementById("descripcioEdad").innerHTML = text;
	}
	function borrarDescripcioEdat(){  
	    document.getElementById("descripcioEdad").innerHTML = "";  
	}
	//Observacions
	function posarDescripcioObs(text){  
		document.getElementById("descripcioObs").innerHTML = text;
	}
	function borrarDescripcioObs(){  
	    document.getElementById("descripcioObs").innerHTML = "";  
	}
	//Ciutat
	function posarDescripcioCiutat(text){  
		document.getElementById("descripcioCiutat").innerHTML = text;
	}	    	    
	function borrarDescripcioCiutat(){  
	    document.getElementById("descripcioCiutat").innerHTML = "";  
	}
			// Mail
	...
	function posarDescripcioVideoclip(text){  
		document.getElementById("descripcioVideoclip").innerHTML = text;
	}	    
	function borrarDescripcioVideoclip(){  
	    document.getElementById("descripcioVideoclip").innerHTML = "";  
	}

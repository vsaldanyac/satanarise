<?php
    ...
    public $formulari_2_ok; /* control dels formularis */
		...
		{
			if (isset($formulari['enviat_formulari_2'])) 
			{ /* formulari 1 enviat */
                $cronicas->num_div=$formulari['num_div'];
                $cronicas->crear_divisions();
                ...
                if (($cronicas->mes)<10) $cronicas->mes='0'.$cronicas->mes; 
                $cronicas->dia=$formulari['dia'];
                if (($cronicas->dia)<10) $cronicas->dia='0'.$cronicas->dia;
...
<?php			if ($punter!=1) {
?>					
                <a class="linkk" href="index_cp.php?sec=cronicas&action=edit&punter=1"><img class="ico_navegador" src="../pics/containers/max_prev.jpg" width="43" height="43" /></a>
<?php
				}
				if ($punter!=1) {
						$punter_dir=$punter-10;
					print '<a class="linkk" href="index_cp.php?sec=cronicas&action='.$action.'&punter='.$punter_dir.'"><img class="ico_navegador" src="../pics/containers/prev.jpg" width="43" height="43" /></a>';
				}

                if ($numero>=($punter+10)) {
						$punter_dir=$punter+10;
					print '<a class="linkk" href="index_cp.php?sec=cronicas&action='.$action.'&punter='.$punter_dir.'"><img class="ico_navegador" src="../pics/containers/next.jpg" width="43" height="43" /></a>';
				}                
                if ($numero>=($punter+10)) {
					$punter_dir=((number_format(($numero/$quantitat), 0)*$quantitat)+1)-10;
					print '<a class="linkk" href="index_cp.php?sec=cronicas&action='.$action.'&punter='.$punter_dir.'"><img class="ico_navegador" src="../pics/containers/max_next.jpg" width="43" height="43" /></a>';
				}
?>
            </div>    
<?php

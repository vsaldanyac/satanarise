<?php
	...
	class ob_entrevistes_web
	{
		...
		/* consultar review a la bbdd a partir d'una id */
		{
            ...
            {
                case 'ES':
                    $query= "select entrevistes.identrevistes, entrevistes.banda, entrevistes.link, entrevistes.titol_es, entrevistes.tipus, entrevistes.texte_es, entrevistes.idcolaboradors, entrevistes.data, colaboradors.nom from entrevistes left join colaboradors on entrevistes.idcolaboradors=colaboradors.idcolaboradors where identrevistes=".$id;
                break;
                case 'CAT':
                    $query= "select entrevistes.identrevistes, entrevistes.banda, entrevistes.link, entrevistes.titol_cat, entrevistes.tipus, entrevistes.texte_cat, entrevistes.idcolaboradors, entrevistes.data, colaboradors.nom from entrevistes left join colaboradors on entrevistes.idcolaboradors=colaboradors.idcolaboradors where identrevistes=".$id;
                break;
            }
		...
		public function mostrar_entrevista_unica ($idioma,$bd)
		{
            ...
            */
            ...
            print '<a class="linkk" href="index.php?'.$link_idioma.'#'.convertir_cadena_arxiu($entrevista->colaborador).'" target="_blank">'.$entrevista->colaborador.'</a><br />'.$this->timestamp_a_data($entrevista->timestamp).'</p></div>';
		...
		{
			$query= "select visites from entrevistes where identrevistes = $id";	
			$this->resultat_consulta=$bd->query($query);
			if ($this->resultat_consulta!=FALSE) 
			{
				$resultat=$this->resultat_consulta->fetch_assoc();

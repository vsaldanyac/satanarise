...
<link rel="shortcut icon" href="../favicon.ico" type="image/x-icon" />'."\n";
	...
	/* control de seccio, si la seccio del parametre no existeix en funcio de l'idioma sera news o noticias */
			...
			if ((($this->section != 'inicio') && ($this->section != 'criticas') && ($this->section != 'noticias') && ($this->section != 'colaboradores') && ($this->section != 'conciertos') && ($this->section != 'cronicas') && ($this->section != 'entrevistas') && ($this->section != 'entrevistasn') && ($this->section != 'carta') && ($this->section != 'opinion') && ($this->section != 'logout') && ($this->section != 'usuarios') && ($this->section != 'memes'))) {
				$this->section = 'inicio';
			...
			if ((($this->section == 'criticas') || ($this->section == 'noticias') || ($this->section == 'conciertos') || ($this->section == 'usuarios') || ($this->section == 'opinion') || ($this->section == 'carta') || ($this->section == 'colaboradores') || ($this->section == 'cronicas') || ($this->section == 'entrevistas') || ($this->section == 'entrevistasn') || ($this->section == 'memes'))) {

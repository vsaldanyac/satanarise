      ...
      */
      ...
      for ($y=0;$y<5;$y++)
      {
          ...
          if ($entrevista->imgs[$y]!='')
          {
              if (($y==0) || ($y==2)  || ($y==4))
              {
                  $link_img[$y]='<a href="pics/entrevistes_pics/'.$entrevista->imgs[$y].'" rel="lightbox[.$entrevista->banda.]" title="'.$entrevista->banda.'"><img class="esq" src = "pics/entrevistes_pics/'.$entrevista->imgs[$y].'" width="350" alt="'.$entrevista->banda.'" /></a>';
              } else {
                  $link_img[$y]='<a href="pics/entrevistes_pics/'.$entrevista->imgs[$y].'" rel="lightbox[.$entrevista->banda.]" title="'.$entrevista->banda.'"><img class="dret" src = "pics/entrevistes_pics/'.$entrevista->imgs[$y].'" width="350" alt="'.$entrevista->banda.'" /></a>';
              }
          }
      }

...
/*			} else {
		...
		public function formulari ()
		{
			...
			if (count($this->imgs)!=0)
			{
				...
				print 'Imagenes subidas:<br />';
				$contador=0;
				for ($i=0;$i<5);$i++) 
				{
					print '<img src="../pics/not/'.$noticia->imgs[$i].'" /><br />';
					print '<input type="hidden" name="arxius_'.($i+1).'" value="'.$noticia->imgs[$i].'" />';
					$contador++;
				}
				$x=1;
				print '<input type="hidden" name="arxius_pujats" value="'.$contador.'" />';
				while ($contador<5)
				{
					print '<input type="file" name="file_'.$x.'" id="file_1"/><br />';
					$x++;
					$contador++;
				}
				...
				print '<input type="hidden" name="arxius_pujats" value="0" />';
				print '<input type="file" name="file_1" id="file_1"/><br />';
				print '<input type="file" name="file_2" id="file_2"/><br />';
				print '<input type="file" name="file_3" id="file_3"/><br />';
				print '<input type="file" name="file_4" id="file_4"/><br />';			
				print '<input type="file" name="file_5" id="file_5"/><br />';
			}
			print '</p>';
